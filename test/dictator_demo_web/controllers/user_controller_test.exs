defmodule DictatorDemoWeb.UserControllerTest do
  use DictatorDemoWeb.ConnCase

  alias DictatorDemo.Accounts

  @create_attrs %{email: "some email", encrypted_password: "some encrypted_password", name: "some name"}
